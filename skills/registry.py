...
MENVIS_SCHEMAS = sys_schemas + PHONE_SCHEMAS + UTILITIES_SCHEMAS + WEB_SCHEMAS + MEMORY_SCHEMAS + OS_SCHEMAS + KEYBOARD_SCHEMAS + MEDIA_SCHEMAS + ROUTINE_SCHEMAS + NOTIF_SCHEMAS + COOL_SCHEMAS + EXTRA_SCHEMAS + SMART_SCHEMAS
